	...
	if request.method == "POST":
		...
		if user is not None:
			...
			if saved_cart:
				...
				# addthe loaded cart dict to session
				# get the cart
				cart = Cart(request)
...
def register_user(request):
	...
	if request.method == "POST":
		...
		if form.is_valid():
			...
			login(request, user)
			messages.success(request, ("Username created! Fill out your User Info"))
